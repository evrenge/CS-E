...
| **(3)(d)(iv)** | Alternatively, base the fatigue life on an agreed safety margin to burst of a minimum strength part; typically a 2/3 factor has been applied to the minimum burst life, and any factor used should be justified for a particular material. | Permitted |
...
| **(3)(d)(v)(5)(a)** | Determine the serviceable and repairable damage limits using a process approved by the Agency and summarised in the Service Management Plan, as a function of part, part location and damage type, covering at least nicks, dents, scratches and cracks. Publish the serviceable and repairable limits in the Instructions for Continued Airworthiness. | Required |
